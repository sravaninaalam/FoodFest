          ...
          <Formik 
              ...
              <div className='bg-slate-200 w-2/3 md:w-96 mx-10 md:mx-auto my-5 p-5 shadow-md rounded-lg'>
                ...
                <Form>
                     ...
                     <label>Email:</label>
                     <Field type='email' name='mail' className='w-56 md:w-72 border border-black rounded-md p-1 m-2'/>
                     ...
                     <button type='submit' className=' m-2 p-1 w-56 md:w-72 bg-blue-400 rounded-md'>Signup</button>
                </Form>
